...
from students.utils import get_current_group, get_groups
...
class UtilsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # # create student
        student, created = Student.students.get_or_create(
            id=1,
            first_name="Vitaliy",
            last_name="Podoba",
    ...
    def test_get_groups(self):
        ...
        # print(get_groups(request))
        self.assertEqual(get_groups(request), [
            {'id': 1, 
             'str': 'Group1 (Vitaliy Podoba)', 
             'selected': False}, 
            {'id': 2, 
             'str': 'Group2', 
             'selected': True}
